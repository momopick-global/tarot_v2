    ...
    <main className="flex-1">
      <section className="mx-auto w-full max-w-[390px] px-4 pb-6 pt-6">
        <div className="mx-auto w-full max-w-[350px]">
          ...
          <div className="mt-8 space-y-7 leading-[1.55] text-white">
            <div>
              <div className="font-bold leading-none">1. 서비스 소개</div>
              <p className="mt-2 leading-[1.45] text-text-sub">
                당신의 질문에 카드가 답합니다
                <br />
            ...
            <div>
              <div className="font-bold leading-none">2. 유어타로 특징</div>
              <ul className="mt-2 space-y-1 leading-[1.45] text-text-sub">
                <li>✓ 쉬운 타로 해설</li>
                <li>✓ 다양한 운세 리딩</li>
                <li>✓ 유명한 타로 마스터</li>
                <li>✓ 간편한 이용</li>
            ...
            <div>
              <div className="font-bold leading-none">3. 타로의 의미</div>
              <p className="mt-2 leading-[1.45] text-text-sub">
            ...
            <div>
              <div className="font-bold leading-none">4. 추천 대상</div>
              <ul className="mt-2 space-y-1 leading-[1.45] text-text-sub">
                <li>✓ 오늘의 운세가 궁금할 때</li>
            ...
            <div>
              <div className="font-bold leading-none">5. 지금 카드를 선택하세요</div>
              <p className="mt-2 leading-[1.45] text-text-sub">
                카드를 선택하고
                <br />
                당신의 타로 메시지를 확인해보세요.
