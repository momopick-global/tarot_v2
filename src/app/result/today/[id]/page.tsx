  ...
  return (
    <main className="flex-1">
      <section className="mx-auto w-full max-w-[390px] px-5 pt-10 pb-6">
        <h1 className="text-md font-semibold">오늘의 결과</h1>
        <p className="mt-4 leading-[22px] text-neutral-60">
        ...
        <div className="mt-8 rounded-xl bg-[rgba(255,255,255,0.02)] p-5">
          ...
          <p className="mt-2 leading-[22px] text-neutral-60">
        ...
        <div className="mt-8">
          <Link
            href="/"
            className="block rounded-xl bg-btn-primary px-5 py-4 text-center text-lg font-semibold text-neutral-10"
          >
            홈으로
          </Link>
        </div>
